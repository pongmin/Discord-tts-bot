...
사용법:
    python reparse_matches.py
    python reparse_matches.py --limit 500   # 앞에서부터 일부만 (테스트용)
"""

import argparse

import scouting_db as db
from raw_match_store import RAW_MATCH_DIR, raw_match_path, load_raw_match
from match_collector import build_match_row, store_all_participants
...
def main() -> None:
    ...
    try:
        ...
        if total == 0:
            print("data/raw_matches/에 저장된 원본이 없음. 먼저 collect_matches.py로 수집해줘.")
            return
