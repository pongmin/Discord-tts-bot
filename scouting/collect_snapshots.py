...
사용법:
    python -m scouting.collect_snapshots "Hide on bush#KR1"
    python -m scouting.collect_snapshots "Hide on bush#KR1" "Faker#KR1"
...
from riot.riot_api import parse_riot_id, get_account_by_riot_id, RiotApiError
from scouting.snapshot_collector import collect_player_snapshots
